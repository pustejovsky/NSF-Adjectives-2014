...
Even two of the examples given above---\emph{tall} and \emph{alleged}---are associated with inferences of this type, and are not well-treated on the standard model. Our preliminary investigations suggest that this a common profile, and that simple intersective  adjectives are rare in natural corpora.
...
\vspace{-0.5em}
\enumsentence{
Given the construction $[A_{int} \; N]$, where $A_{int}$ includes {\it alleged, ...}, then: \\
a. $[ A_{int}\; N ] \; \nvDash \; N$ \\
b. $[ A_{int} \; A_2\; N ] \; \nvDash \; A_2$\\
c.   $[ A_{int} \; A_2\; N ] \leadsto \; N$
\label{AAN}
}
\vspace{-0.5em}
...
a. $[ A_{int}\; N ] \; \nvDash \; N$ \\
b. $\leadsto$ $N'$  where $N \subseteq N'$
}
\vspace{-0.5em}
...
$[ A_{int} \; N \; XP_{mod}  ] \leadsto \; N$
\\
d. Hypernym reading:  $\;\;\;\;\;\;\;\;\;\;$
$[ A_{int}\; N ] \;  \leadsto$ $N'$  where $N \subseteq N'$
}
