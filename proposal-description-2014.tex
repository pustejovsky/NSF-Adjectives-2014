...
\begin{itemize}
\moveup
\item a small annotated corpus
\moveup
\item annotation guidelines
\moveup
\item models that evaluate how well the isolated factors explain the data of the experiments
\moveup
...
===========================================================================
%\noindent These constructions   constitute  patterns that license specific inferences associated with classes of adjectives, and  can be exploited in the context  of text-based inference systems, such as the RTE (\cite{amoia2006adjective}). 
...
%For these reasons, We have chosen to study the three different classes of adjectives mentioned above, which require refinements and additions to the recognized inference patterns. 
...
%evaluation and the speaker/writerâs attitudes are central components; (b) empirical data 
...
For the predicative adjectives, we translate the pattern profiles we have developped into the probabilistic rules used in Biutee and create a new set of RTE TH pairs (again 5 pairs per pattern) which we submit again to MT Turkers and to the Biutee system. The measure of success is the agreement between the Biutee score and the MT score for each adjective.   
