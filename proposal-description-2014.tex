...
However, the inferential reach of adjectives is greater than the treatment of the adjective on its own allows even if we extend the treatment to take into account subsective, privative and non-sbusective adjectives\footnote{
\enumsentence{
 Suppose the construction, [A N], is used to describe object O. Then A can be classified as: \\
\vspace{-.25in}
\begin{multicols}{2}
